        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-wrap -mx-3">
                    @php
                        $arr = [['Customers', $countCustomers, 'Begining', 'fa-solid fa-users', 'from-blue-500 to-violet-500'], ['Mechanics', $countStuff, 'last week', 'fa-solid fa-clipboard-user', 'from-red-600 to-orange-600'], ['Feedbacks', $countFeeds, 'last month', 'fa-solid fa-face-smile', 'from-orange-500 to-yellow-500']];
                    @endphp
                    <!-- cards -->
                    @foreach ($arr as $card)
