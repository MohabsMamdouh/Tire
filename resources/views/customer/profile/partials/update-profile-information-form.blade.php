<section>
    ...
    <form method="post"
        action="{{ route('customer.profile.update', ['customer' => Auth::guard('customer')->user()->id]) }}"
        ...
        <div>
            ...
            <x-text-input id="customer_fname" name="customer_fname" type="text" class="mt-1 block w-full"
                :value="old('customer_fname', $user->customer_fname)" required autofocus autocomplete="fname" />
            <x-input-error class="mt-2" :messages="$errors->get('customer_fname')" />
        </div>
        ...
        <div>
            ...
            <x-text-input id="customer_address" name="customer_address" type="text" class="mt-1 block w-full"
                :value="old('customer_address', $user->customer_address)" required autofocus autocomplete="customer_address" />
            <x-input-error class="mt-2" :messages="$errors->get('customer_fname')" />
        </div>
        ...
        <div>
            ...
            <x-text-input id="customer_phone" name="customer_phone" type="text" class="mt-1 block w-full"
                :value="old('customer_phone', $user->customer_phone)" required autofocus autocomplete="customer_phone" />
