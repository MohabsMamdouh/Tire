<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full text-black" type="text" name="name" :value="old('name')" required
                autofocus />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full text-black" type="text" name="phone" :value="old('phone')"
                required autofocus />
