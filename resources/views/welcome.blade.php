...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24" id="home">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full">{{ __('Tire Website') }}</p>
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    {{ __('What does '.config('app.name', 'Tire').' website aim to?') }}
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    {{ __('Website we make you close to the best mechanic nearest to you whereever you are!') }}
                </p>
                <a href="#joinUs"
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        {{ __('Fast service in connected car drivers  with mechanic nearest to each other') }}
                        <br />
                        <br />
                    </p>
                </div>
                <div class="w-full sm:w-1/2 p-6">
                    <svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                        <title>{{ __('Connected World') }}</title>
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                            {{ __('Easy User interface') }}
                        </h3>
                        <p class="text-gray-600 mb-8">
                            {{ __("It's easy to use our website for anyone with easy interface") }}
                            <br />
                            <br />
                        </p>
                    </div>
    ...
    <section class="bg-white border-b py-8" id="reviews">
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="flex items-center justify-start">
                            <p
                                class="cursor-pointer mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                                {{ $feed->mechanic }}
                            </p>
                        </div>
                    </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12" id="joinUs">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
            {{ __("Join To ")  . config('app.name', 'Tire') . "'s customers" }}
        </h2>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <h3 class="my-4 text-3xl leading-tight">
            {{ __('It\'s free, What are you waiting for!') }}
        </h3>
